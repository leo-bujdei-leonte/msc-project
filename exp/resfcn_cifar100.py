...
from src.models.fcn import ResFCN
...
save_path = "./data/models/resfcn_cifar100"
data_root = "./data/image/CIFAR100"
project = "ResFCN-cifar100"
description = "ResFCN on CIFAR100"
...
extra_args = [
    ...
    ("--num-conv-layers", int, 32,  "number of convolutional layers"),
